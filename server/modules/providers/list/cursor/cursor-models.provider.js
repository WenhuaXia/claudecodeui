...
import { buildDefaultProviderCurrentActiveModel, sanitizeLeafDirectoryName, writeProviderSessionActiveModelChange, } from '../../../../shared/utils.js';
...
const runCursorListModels = () => new Promise((resolve, reject) => {
...
const buildCursorModelsDefinition = (models) => {
    const options = [];
