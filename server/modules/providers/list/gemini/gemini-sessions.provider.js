...
function extractGeminiThoughts(thoughts) {
...
function buildGeminiTokenUsage(tokens) {
...
async function getGeminiLegacySessionMessages(sessionFilePath) {
    try {
...
async function getGeminiJsonlSessionMessages(sessionFilePath) {
    const messages = [];
    let tokenUsage;
    try {
...
//# sourceMappingURL=gemini-sessions.provider.js.map