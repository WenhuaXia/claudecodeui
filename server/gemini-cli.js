...
async function spawnGemini(command, options = {}, ws) {
    ...
    const resolvedModel = await providerModelsService.resolveResumeModel('gemini', sessionId, options.model);
    ...
    return new Promise((resolve, reject) => {
        ...
        geminiProcess.on('close', async (code) => {
            ...
            if (code === 0) {
                ...
                reject(new Error(terminalFailureReason
                    || (code === null
...
export { spawnGemini, abortGeminiSession, isGeminiSessionActive, getActiveGeminiSessions };
